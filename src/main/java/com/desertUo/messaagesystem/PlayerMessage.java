...
public class PlayerMessage {
    @BsonId
    private ObjectId id;          // MongoDB will auto-generate this
    private UUID sender;
    ...
    // No-args constructor required for MongoDB POJO mapping
    ...
    public Document toDocument() {
        ...
        return new Document("sender", this.sender.toString())
                .append("receiver", this.recipient.toString()) // Matches your reference
